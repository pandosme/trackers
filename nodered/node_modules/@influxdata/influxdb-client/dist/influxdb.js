  ...
  ***************************************************************************** */
                  ...
                  var callbacks = {
                      ...
                      complete: function () {
                          ...
                          if (responseStatusCode == 204 || responseStatusCode == undefined) {
                              ...
                              var message = "204 HTTP response status code expected, but " + responseStatusCode + " returned";
  ...
  var FetchTransport = /** @class */ (function () {
      function FetchTransport(connectionOptions) {
          ...
          if (this.url.endsWith('/api/v2')) {
              ...
              Logger.warn("Please remove '/api/v2' context path from InfluxDB base url, using " + this.url + " !");
          }
      }
                  ...
                  switch (_a.label) {
                      case 0:
                          if (callbacks === null || callbacks === void 0 ? void 0 : callbacks.responseStarted) {
                              ...
                              observer.responseStarted(headers_1, response.status);
                          }
      ...
      FetchTransport.prototype.fetch = function (path, body, options) {
          ...
          return fetch("" + this.url + path, __assign({ method: method, body: method === 'GET' || method === 'HEAD'
                  ? undefined
                  : typeof body === 'string'
                      ? body
  ...
  var QueryApiImpl = /** @class */ (function () {
      ...
      QueryApiImpl.prototype.with = function (options) {
          return new QueryApiImpl(this.transport, __assign(__assign({}, this.options), options));
      };
      ...
      QueryApiImpl.prototype.createExecutor = function (query) {
          ...
          return function (consumer) {
              ...
              }, chunksToLines(consumer, _this.transport.chunkCombiner));
          };
      };
