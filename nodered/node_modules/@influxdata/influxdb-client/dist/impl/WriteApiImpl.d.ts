...
import { WriteOptions, WritePrecisionType } from '../options';
...
export default class WriteApiImpl implements WriteApi, PointSettings {
    ...
    constructor(transport: Transport, org: string, bucket: string, precision: WritePrecisionType, writeOptions?: Partial<WriteOptions>);
